...
/**
 * Generated class for the ReportRepairingPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-report-repairing',
  templateUrl: 'report-repairing.html',
})
export class ReportRepairingPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ReportRepairingPage');
  }
